...
MessageContext = Literal["connection", "queue", "transfer"]
...
_TOKEN_TRANSLATIONS = {
    ...
    "connection_not_tested": "transfer.connection_required",
    "invalid_remote_directory": "validation.destination_invalid",
...
def localized_backend_message(
    ...
    *,
    ...
    if context == "queue":
        return translator.t("errors.queue_failed", detail=detail)
